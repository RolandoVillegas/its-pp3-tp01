...
import { loginIntentoEntity } from "../modules/usuario/entity/login-intento.entity.js";
...
const AppDataSource = new DataSource({
  ...
  entities: [
    profesionalEntity, UsuarioEntity, loginIntentoEntity, novedadEntity, servicioEntity, servicioDttEntity
  ],
